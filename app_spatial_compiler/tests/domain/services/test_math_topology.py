...
def test_resolver_reduces_superscript_manifold(
    synthetic_superscript_nodes: list[SpatialNode],
) -> None:
    """
...
def test_resolver_reduces_fraction_manifold(
    synthetic_fraction_nodes: list[SpatialNode],
) -> None:
    """
