...
from semantic_pdf_splitter.vision.services.encoder_service import generate_semantic_ast_node
...
def encode(
    ...
    if use_fake:
        ...
        from semantic_pdf_splitter.vision.adapters.external_api import ExternalAPIAdapter
        ...
        from semantic_pdf_splitter.vision.adapters.local_quantized import LocalQuantizedAdapter
